    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[400px] relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-semibold text-white tracking-tight mb-1.5">{t('auth.loginTitle')}</h1>
          <p className="text-sm text-neutral-500">Clinical Cognitive Screening Platform</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="card-static space-y-5">
          ...
          <p className="text-center text-sm text-neutral-500">
            {t('auth.noAccount')}{' '}
            <Link to="/signup" className="text-blue-400 hover:text-blue-300 font-medium transition-colors">{t('nav.signup')}</Link>
          </p>
        </form>
